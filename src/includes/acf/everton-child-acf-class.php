    ...
    if( function_exists('acf_add_local_field_group') ):
      ...
      acf_add_local_field_group(array(
        ...
        'fields' => array(
          ...
          array(
            'key' => 'field_5f6a7570f55c1',
            'label' => 'Google Maps API Key',
            'name' => 'google_maps_api_key',
            'type' => 'text',
            'instructions' => 'Paste your Google Maps API Key here to ensure the map content module works.',
            'required' => 0,
            'conditional_logic' => 0,
            'wrapper' => array(
              'width' => '',
          ...
          array(
            'key' => 'field_602f00853a3ed',
            'label' => 'CTA',
            'name' => 'popup_cta',
            'type' => 'link',
            'instructions' => 'Note: only visible on mobile displays.',
            'required' => 0,
            'conditional_logic' => 0,
            'wrapper' => array(
              'width' => '',
      ...
      acf_add_local_field_group(array(
        ...
        'fields' => array(
          ...
          array(
            'key' => 'field_5f97474bfae58',
            'label' => 'Video',
            'name' => 'video',
            'type' => 'image',
            'instructions' => 'Upload/select the featured hero video.',
            'required' => 0,
            'conditional_logic' => array(
              array(
                array(
          ...
          array(
            ...
            'layouts' => array(
              ...
              'layout_5f5effee1f5cb' => array(
                ...
                'label' => 'Title, Content, CTA & Image (2 Cols)',
                'display' => 'block',
                'sub_fields' => array(
                  array(
              ...
              'layout_5f7d4a7d49490' => array(
                'key' => 'layout_5f7d4a7d49490',
                'name' => 'title_content_image',
                'label' => 'Title, Content & Image (2 Cols)',
                'display' => 'block',
                'sub_fields' => array(
                  array(
                    'key' => 'field_5f7d4a7d49491',
                    'label' => 'Alignment',
                    'name' => 'alignment',
                    'type' => 'select',
                    'instructions' => '',
              ...
              'layout_5f695cfced14c' => array(
                'key' => 'layout_5f695cfced14c',
                'name' => 'iframe',
                'label' => 'iFrame',
                'display' => 'block',
                'sub_fields' => array(
                  array(
                    'key' => 'field_5f695d924f794',
                    'label' => 'Title',
                    'name' => 'title',
                    'type' => 'text',
                    'instructions' => 'If entered this title will appear above the iFrame container.',
                    'required' => 0,
                    'conditional_logic' => 0,
                    'wrapper' => array(
                      'width' => '50',
                  ...
                  array(
                    'key' => 'field_5f695d01ed14d',
                    'label' => 'URL',
                    'name' => 'url',
                    'type' => 'url',
                    'instructions' => 'Enter the iFrame URL.',
                    'required' => 1,
                    'conditional_logic' => 0,
                    'wrapper' => array(
                      'width' => '50',
              ...
              'layout_5f698f81f83b9' => array(
                'key' => 'layout_5f698f81f83b9',
                'name' => 'contact_form',
                'label' => 'Contact Form',
                'display' => 'block',
                'sub_fields' => array(
                  array(
                    'key' => 'field_5fad24e51bce5',
                    'label' => 'Info',
                    'name' => '',
                    'type' => 'message',
                    'instructions' => '',
                    ...
                    'message' => 'This content module will output the RENTCafe contact form, along with the contact details configured on the Options page.',
                    'new_lines' => 'wpautop',
                    'esc_html' => 0,
                  ),
                ),
              ...
              'layout_5f6a75ba8da89' => array(
                'key' => 'layout_5f6a75ba8da89',
                'name' => 'map',
                'label' => 'Map',
                'display' => 'block',
                'sub_fields' => array(
                  array(
                    'key' => 'field_5f6a75ba8da8a',
                    'label' => 'Map',
                    'name' => 'map',
                    'type' => 'post_object',
                    'instructions' => 'Add a Filtered Gallery from the main admin menu, and then select it here to display in the page content.',
              ...
              'layout_5f7d0407786ff' => array(
                'key' => 'layout_5f7d0407786ff',
                'name' => 'rentcafe_floorplans',
                'label' => 'Rentcafe Floorplans',
                'display' => 'block',
                'sub_fields' => array(
                  array(
                    'key' => 'field_5f7d041678700',
                    'label' => 'Information',
                    'name' => '',
                    'type' => 'message',
                    'instructions' => '',
              ...
              'layout_5f69556c0093a' => array(
                'key' => 'layout_5f69556c0093a',
                'name' => 'content_anchor',
                'label' => 'Content Anchor',
                'display' => 'block',
                'sub_fields' => array(
                  array(
                    'key' => 'field_5f6955720093b',
                    'label' => 'Anchor',
                    'name' => 'anchor',
                    'type' => 'text',
                    'instructions' => 'Enter a (unique to this page) anchor ID, using only lowercase letters and hyphens.<br/><br/>This can then be used in a link to scroll the user to the content.',
                    'required' => 0,
                    'conditional_logic' => 0,
                    'wrapper' => array(
                      'width' => '',
